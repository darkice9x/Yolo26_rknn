    ...
    if platform in ["rv1109","rv1126","rk1808"] :
        ...
        if do_quant:
            rknn.hybrid_quantization_step1(
                ...
                proposal= False,
                custom_hybrid=[['/model.23/one2one_cv4.2/one2one_cv4.2.0/act/Mul_output_0','985'],
                                ['/model.23/one2one_cv4.1/one2one_cv4.1.0/act/Mul_output_0','985'],
                                ['/model.23/one2one_cv4.0/one2one_cv4.0.0/act/Mul_output_0','985']]
            )
